...
平台目前维护 **164项候选资源**，经人工质量复核后形成 **118项前台精选教学资源**：

- **118项进入前台精选教学资源库**；
- **46项资源保留在后台候选/对标库**，包括培养方案、项目介绍、通用文档、重复Quick Start、组织导航页以及与核心资源高度重合的条目；
- **“顶尖高校课程”为第一资源专区，共24项，其中国内高校7项、海外高校17项**；
- 北京大学金融工程实验室 **“机器学习与资产定价”** 置于课程资源第一位；
- **“经典教材与专著”为第二资源专区，共34本/套，其中文教材与专著10项、英文教材与专著24项**；
- 原“AI＋金融/金融工程前沿”和“工具、代码与实验”整合为第三专区 **“AI＋金融工程方法与实践”**，从原53项相关资源中精选 **22项**；
...
3. **AI＋金融工程方法与实践（22项）**  
   将原“AI＋金融/金融工程前沿”和“工具、代码与实验”合并后重新精选，强调领域专用、可运行、可复现和高教学增量，内部划分为4组：
   - 金融LLM与智能体：6项
   - 金融机器学习与因果方法：4项
   - 量化交易与金融工程工具：8项
   - 计算金融与计算经济学：4项
...
第三专区不再追求“大而全”。以下类型默认不进入前台精选：

- NumPy、pandas、Matplotlib、Jupyter等通用基础文档；
- PyTorch、XGBoost、scikit-learn、TensorFlow等通用AI教程；
- 与主项目高度重复的Quick Start、Examples页面；
- 仅提供组织/项目导航而缺少明确教学入口的页面；
- 与已保留资源功能高度重合、教学增量有限的条目。

这些资源仍保存在候选数据中，后续如出现更强教学用途可重新评估。
...
**不设置固定数量上限，但前台坚持精简。** 新资源只有在质量、教学增量或代表性上能够替代/补充现有精选资源时，才进入前台；否则先进入后台候选库。
