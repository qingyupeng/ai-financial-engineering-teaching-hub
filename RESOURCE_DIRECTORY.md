...
| 核心专区 | 数量 | 说明 |
|---|---:|---|
| **1. 高校优质课程** | **24** | 国内7项＋海外17项，按课程材料质量筛选 |
| **2. 经典教材与专著** | **34** | 中文10项＋英文24项 |
| **3. AI＋金融工程方法、工具与实验** | **22** | 金融LLM/Agent＋金融ML/因果＋量化工具＋计算金融/经济学 |
| **4. 案例** | **10** | 金融机构真实使用AI的高质量业务案例 |
| **5. AI赋能教学** | **6** | 系统课程、Agentic Research、AI教学设计与高校教师实践 |
| **合计** | **96** | |

## 1. 高校优质课程（24项）

> 本专区按**课程资源质量而非学校标签**筛选，优先进入具有完整课程结构、讲义、课件、代码、习题、视频、syllabus或实验材料的课程。
...
> 本专区以《智能体与社会科学研究》为质量标杆。只保留具有系统课程、连续专题、完整讲义/Notebook、可复用作业/案例或Agentic Research工作流的资源；普通产品说明、提示词合集和浅层功能指南退出前台。
...
- 有连续课程、系列视频、系统讲义或完整Notebook；
- 有可直接复用的作业、课堂活动、AI使用政策、评分rubric或项目设计；
- 能覆盖教师科研或教学的完整工作流，而不是单一功能演示；
- 对高校教师具有明确的可迁移价值；
- 有高校、研究机构、作者本人或正式开源项目的一手来源；
...
1. 外部资源优先保留高校、出版社、金融机构、研究机构或项目官方链接。
2. 主资源库优先指向课程主页、讲义、代码、实验平台、视频、syllabus、案例或完整工作流等实质资源。
3. 第一专区按课程资源质量筛选，不以学校排名或机构名气单独决定准入。
4. 第三、第四、第五专区均坚持“少而精”和替换制。
5. 教材不重新上传受版权保护的全文。
6. 候选库不设置固定数量上限，但前台精选始终保持高门槛。
